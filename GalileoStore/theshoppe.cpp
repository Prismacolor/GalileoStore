...
public:
	StoreItem() = default;
	StoreItem(int item_number, string name, int quantity, double price) {
		Name = name;
		Quantity = quantity;
		Price = price;
	...
	double getTotal(int quantity, double item_price) {
...
public: 
	Weapon( int item_number, string name, int quantity, double price):StoreItem(item_number, name, quantity, price){
...
public:
	Clothing(int item_number, string name, int quantity, double price) :StoreItem(item_number, name, quantity, price) {
...
public:
	Potion(int item_number, string name, int quantity, double price) :StoreItem(item_number, name, quantity, price) {
...
double getCustomerTotal(list<double> customer_amounts);
bool canCustomerPay(double purse, double total);
